...
<!-- First Row: Orders, Products, Categories, Reviews -->
<div class="row">
  <!-- Total Order -->
...
<!-- Second Row: New, Processing, Delivered, Cancelled Orders -->
<div class="row">
  <!-- New Order -->
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Models\Order::countDeliveredOrder() }}</div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Models\Order::countCancelledOrder() }}</div>
          </div>
          <div class="col-auto">
